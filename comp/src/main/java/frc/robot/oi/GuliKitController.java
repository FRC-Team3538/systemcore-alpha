...
/**
 * Handle input from GuliKit controllers connected to the Driver Station.
 *
 * <p>This class handles GuliKit input that comes from the Driver Station. Each time a value is
 ...
 */
public class GuliKitController extends GenericHID implements Sendable {
  /** Represents a digital button on a GuliKitController. */
  public enum Button {
    /** B button. */
    kB(1),
    /** A button. */
  ...
  /** Represents an axis on an GuliKitController. */
  public enum Axis {
    /** Left X axis. */
    kLeftX(0),
    /** Left Y axis. */
   ...
   */
  public GuliKitController(final int port) {
    super(port);
  ...
  public boolean getLeftUpperPaddleButton() {
    return getRawButton(Button.kX.value);
  }

  public boolean getLeftLowerPaddleButton() {
    return getRawButton(Button.kY.value);
  }

  public boolean getRightUpperPaddleButton() {
    return getRawButton(Button.kA.value);
  }

  public boolean getRightLowerPaddleButton() {
   ...
   *
   * @return The state of the button.
   * @deprecated Use {@link getLeftBumperButton} instead. This function is deprecated for removal to
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.publishConstString("ControllerType", "GuliKit");
