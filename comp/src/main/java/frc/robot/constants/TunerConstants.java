...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.18).withKI(0).withKD(0).withKS(0.247).withKV(0.130).withKA(0.012);
  ...
  public static final CANBus kCANBus = new CANBus("3538_Robot", "./logs/example.hoot");
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.48876953125);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.322265625);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(-0.2314453125);
  ...
  public static Drive createDrivetrain() {
    return new Drive(DrivetrainConstants, 500, FrontLeft, FrontRight, BackLeft, BackRight);
  }
