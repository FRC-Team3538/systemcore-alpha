...
public class ExponentialCurve extends MotionCurve<ExponentialCurve> {
  ...
  public static class Constraints
      extends frc.robot.lib.trajectory.MotionCurve.Constraints<ExponentialCurve> {
    ...
    @Override
    public ExponentialProfile asFullStateMotionProfile() {
      return new ExponentialProfile(this);
    }

    @Override
    public VelocityMotionProfile<ExponentialCurve> asVelocityMotionProfile() {
