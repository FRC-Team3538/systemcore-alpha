...
public class TrapezoidCurve extends MotionCurve<TrapezoidCurve> {
  ...
  public static class Constraints
      extends frc.robot.lib.trajectory.MotionCurve.Constraints<TrapezoidCurve> {
    ...
    @Override
    public TrapezoidProfile asFullStateMotionProfile() {
      return new TrapezoidProfile(this);
    }

    @Override
    public VelocityMotionProfile<TrapezoidCurve> asVelocityMotionProfile() {
