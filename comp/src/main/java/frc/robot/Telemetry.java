...
public class Telemetry {
  ...
  private final double[] m_speedsArray = new double[3];
  ...
  public void telemeterize(SwerveDriveState state) {
    ...
    RJLog.log(drivePose.getTopic().getName(), state.Pose);
    RJLog.log(driveSpeeds.getTopic().getName(), state.Speeds);
    RJLog.log(driveModuleStates.getTopic().getName(), state.ModuleStates);
    RJLog.log(driveModuleTargets.getTopic().getName(), state.ModuleTargets);
    RJLog.log(driveModulePositions.getTopic().getName(), state.ModulePositions);
    RJLog.log(driveTimestamp.getTopic().getName(), state.Timestamp);
    RJLog.log(driveOdometryFrequency.getTopic().getName(), 1.0 / state.OdometryPeriod);
    ...
    SignalLogger.writeDoubleArray("DriveState/Speeds", m_speedsArray);
