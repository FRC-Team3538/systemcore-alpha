...
public class CommandStadiaController extends CommandGenericHID {
   ...
   *
   * @return a Trigger instance representing the ellipses button's digital signal attached to the
   *     {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   ...
   *
   * @return a Trigger instance representing the hamburger button's digital signal attached to the
   *     {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   ...
   *
   * @return a Trigger instance representing the stadia button's digital signal attached to the
   *     {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   ...
   *
   * @return a Trigger instance representing the google button's digital signal attached to the
   *     {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   ...
   *
   * @return a Trigger instance representing the frame button's digital signal attached to the
   *     {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #frame(EventLoop)
   */
   ...
   *
   * @param loop the event loop instance to attach the event to.
   * @return a Trigger instance representing the frame button's digital signal attached to the given
   *     loop.
   */
