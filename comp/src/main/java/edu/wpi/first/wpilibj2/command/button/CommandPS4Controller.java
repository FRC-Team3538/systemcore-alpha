...
public class CommandPS4Controller extends CommandGenericHID {
   ...
   *
   * @param loop the event loop instance to attach the event to.
   * @return a Trigger instance representing the cross button's digital signal attached to the given
   *     loop.
   */
   ...
   *
   * @return a Trigger instance representing the left trigger 1 button's digital signal attached to
   ...
   *
   * @return a Trigger instance representing the right trigger 1 button's digital signal attached to
   *     the {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #R1(EventLoop)
   */
  public Trigger R1() {
   ...
   *
   * @return a Trigger instance representing the left trigger 2 button's digital signal attached to
   *     the {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #L2(EventLoop)
   */
  public Trigger L2() {
   ...
   *
   * @return a Trigger instance representing the right trigger 2 button's digital signal attached to
   *     the {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #R2(EventLoop)
   */
  public Trigger R2() {
   ...
   *
   * @param loop the event loop instance to attach the event to.
   * @return a Trigger instance representing the share button's digital signal attached to the given
   *     loop.
   */
   ...
   *
   * @return a Trigger instance representing the L3 (left stick) button's digital signal attached to
   *     the {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #L3(EventLoop)
   */
  public Trigger L3() {
   ...
   *
   * @return a Trigger instance representing the PlayStation button's digital signal attached to the
   *     {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #PS(EventLoop)
   */
  public Trigger PS() {
  ...
  /**
   * Get the left trigger 2 axis value of the controller. Note that this axis is bound to the range
  ...
  /**
   * Get the right trigger 2 axis value of the controller. Note that this axis is bound to the range
   * of [0, 1] as opposed to the usual [-1, 1].
   *
   * @return The axis value.
   */
